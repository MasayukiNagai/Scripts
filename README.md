...
- `tree` — tiny `find`/`sed` script that prints a directory tree.
- `util_python` — reusable Python utilities for CLI args, logging, filesystem checks, and subprocess execution.
